...
class BetaWarningState extends MusicBeatState {
	...
	public override function create() {
		...
		disclaimer.applyMarkup("This engine is still in an alpha state. That means the *majority of the features* are either *buggy* or *incomplete*. If you find any bugs, please report them to the Codename Engine GitHub.\n\nPress ENTER to continue",
			[
